...
DATA_ENGINEERING_TOPICS = [
    ...
    "Data quality validation: Pydantic schemas and pipeline assertions",
    "Data lineage and impact analysis",
    "Columnar vs row-oriented storage: when Parquet beats CSV",
    "Schema evolution and backward compatibility",
    "Parquet file optimization: row groups, compression, and predicate pushdown",
    "S3 small file problems and compaction strategies",
    "Data contracts: enforcing schema agreements between producers and consumers",
    "Temporal audit tables and historical state tracking (pghistory)",
    ...
    "Event-driven pipelines with SQS and SNS",
    ...
    "Isolation levels in PostgreSQL: read committed vs serializable for ETL",
    "S3 event notifications for triggering downstream pipelines",
    "boto3 session management: credentials, regions, and retry config",
    ...
    "Airflow sensor patterns: S3KeySensor and external task dependencies",
    "Django migration safety: zero-downtime schema changes for ETL tables",
    "Secrets Manager integration: rotating credentials in long-running jobs",
    "PyArrow Table API: filtering, joins, and aggregation without pandas",
    "Kubernetes pod resource tuning: CPU and memory for ETL workloads",
    "Jinja2 templating patterns for dynamic DAG configuration",
    "PostgreSQL COPY for high-throughput bulk data loading",
    "Airflow XCom patterns: passing data between tasks safely",
    "Python Poetry: managing dependencies in multi-repo data platforms",
    "Django management commands for one-off data operations",
    "SQS dead-letter queues: handling failed pipeline events"
]
